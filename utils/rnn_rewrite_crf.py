...
def dynamic_rnn_with_conditions(cell, inputs, sequence_length=None, initial_state=None,
                dtype=None, parallel_iterations=None, swap_memory=False,
                time_major=False, scope=None):
  """Creates a recurrent neural network specified by RNNCell `cell`.
  ...
  with vs.variable_scope(scope or "rnn") as varscope:
    ...
    (outputs, final_state) = _dynamic_rnn_loop_with_conditions(
        cell,
        inputs,
        state,
        parallel_iterations=parallel_iterations,
...
def _dynamic_rnn_loop_with_conditions(cell,
                      inputs,
                      initial_state,
                      parallel_iterations,
                      swap_memory,
    ...
    def _time_step(time, output_ta_t, state):
        ...
        call_cell = lambda: cell(input_t, state, time=time)  # add params time for crf_decode_with_conditions
