...
@@CrfForwardRnnCell
@@viterbi_decode
@@viterbi_decode_with_conditions
"""
...
from tensorflow.contrib.crf.python.ops.crf import crf_decode_with_conditions
...
from tensorflow.contrib.crf.python.ops.crf import viterbi_decode_with_conditions
